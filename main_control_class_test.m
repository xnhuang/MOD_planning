...
all2alltt_path = strrep(current_path,'\regularized_planning_MDP','\offline_travel_time');
cluster_number = 30;
...
test_case_path = strrep(current_path,'regularized_planning_MDP','test_case');
...
duration = 30;
time_step = 30;
routing_policy_assign = 2;
routing_policy_rebalance = 1;
routing_policy_rebalance_idle = 2;
...
for time_id = 1:length(time_grid)
    if load_test_case == 0
        ...
        customer_list_new = customer_list_log{time_id};
    end
...
%     end
    ...
    [customer_list,vehicle_list,fleet_controller] = fleet_controller.fleet_plan(...
                vehicle_list, ...
                customer_list, ...
                current_time, ...
                demand_state_matrix);
    ...
    [vehicle_list,customer_list,map,customer_delivered] = network_sim(vehicle_list, customer_list, map, 1, time_step);
